...
class _RegisterState extends State<Register> {
  //variabel global dalam class _RegisterState
  String email = "";
  String password = "";
  ...
  //class widget inti dalam class  _RegisterState
  @override
  Widget build(BuildContext context) {
    //for showing loading
    // bool loading = false;

    // fungsi untuk membuat notifikasi transparan
    SystemChrome.setSystemUIOverlayStyle(
        SystemUiOverlayStyle(statusBarColor: Colors.transparent));

    //nilai kembalian widget untuk class register
    return Background(
      child: Stack(
        children: <Widget>[
          Image.asset(
                ...
                Stack(
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        padding: EdgeInsets.fromLTRB(0, 10, 0, 5),
                        child: TextField(
                          onChanged: (value)=>password_conf=value,
                          textAlign: TextAlign.center,
                          decoration: InputDecoration(
